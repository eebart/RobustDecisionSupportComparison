...
import models.dps
import models.intertemporal
import models.planned_adaptive


def base_model(params):
    base = Model('base', function=models.dps.lake_model)
...
def dps_model(params):
    dps = Model('dps', function=models.dps.lake_model)
...
def planned_adaptive_model(params):
    adaptive = Model('plannedadaptive',
                     function=models.planned_adaptive.lake_model)
...
def intertemporal_model(params):
    intertemporal = Model('intertemporal',
                          function=models.intertemporal.lake_model)
